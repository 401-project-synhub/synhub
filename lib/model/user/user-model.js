...
class User extends Model {
   ...
   */
  generateToken(user){
    console.log('jwtuser' ,user.capabilities);
    ...
    jwt.sign({  id: user._id, username: user.username, imgUrl:user.imgUrl, gender:user.gender, capabilities:user.capabilities, expiresIn: 900000, algorithm: 'RS256' }, SECRET);
